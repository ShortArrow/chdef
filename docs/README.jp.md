...
|---|---|---|---|---|
| [`chdef`](../crates/chdef/README.md) | [![crates.io](https://img.shields.io/crates.io/v/chdef)](https://crates.io/crates/chdef) | Rust | ライブラリ | `cargo add chdef` |
| [`chdef-capi`](../crates/chdef-capi/README.md) | [![crates.io](https://img.shields.io/crates.io/v/chdef-capi)](https://crates.io/crates/chdef-capi) | C、C++ | その上の C ABI | `cargo add chdef-capi` |
...
| [`chdef-core`](../crates/chdef-core/README.md) | [![crates.io](https://img.shields.io/crates.io/v/chdef-core)](https://crates.io/crates/chdef-core) | Rust か C のファームウェア | 機器のための生値だけの規則。`no_std`、C の入口つき | `cargo add chdef-core` |
| [`chdef-gen`](../crates/chdef-gen/README.md) | [![crates.io](https://img.shields.io/crates.io/v/chdef-gen)](https://crates.io/crates/chdef-gen) | ファームウェアのビルド、言語は問わない | 定義を Rust または C の定数表に展開する | `cargo install chdef-gen` |
