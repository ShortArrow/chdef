...
| [`chdef-macros`](../crates/chdef-macros/README.md) | [![crates.io](https://img.shields.io/crates/v/chdef-macros)](https://crates.io/crates/chdef-macros) | Rust のファームウェア | 定義をマクロでその場に展開する | `cargo add chdef-macros` |
