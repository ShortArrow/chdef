...
|---|---|---|---|---|
| [`chdef`](./crates/chdef/README.md) | [![crates.io](https://img.shields.io/crates/v/chdef)](https://crates.io/crates/chdef) | Rust | the library | `cargo add chdef` |
| [`chdef-capi`](./crates/chdef-capi/README.md) | [![crates.io](https://img.shields.io/crates/v/chdef-capi)](https://crates.io/crates/chdef-capi) | C, C++ | a C ABI over it | `cargo add chdef-capi` |
